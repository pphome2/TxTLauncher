...
import static com.wswdteam.txtlauncher_2.MainActivity.SETTINGS_COLOR_HOME_BUTTONS_TAG;
import static com.wswdteam.txtlauncher_2.MainActivity.SETTINGS_HOME_ICON_TAG;
import static com.wswdteam.txtlauncher_2.MainActivity.SETTINGS_SYS_ICON_TAG;
import static com.wswdteam.txtlauncher_2.MainActivity.SETTINGS_URL_PRIVATEAI_TAG;
import static com.wswdteam.txtlauncher_2.MainActivity.SETTINGS_URL_SEARCH_TAG;
import static com.wswdteam.txtlauncher_2.MainActivity.defaultPlusFontSizeTitle;
import static com.wswdteam.txtlauncher_2.MainActivity.packageUpdateTime;
import static com.wswdteam.txtlauncher_2.MainActivity.privateAIUrlOrig;
import static com.wswdteam.txtlauncher_2.MainActivity.privateSearchUrlOrig;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        @SuppressLint("UseSwitchCompatOrMaterialCode") Switch c3 = findViewById(R.id.colorButtonCheck);
        ...
        c3.setOnCheckedChangeListener((buttonView, isChecked) -> {
            var settings = MainActivity.sharedPreferences.edit();
            if (isChecked) {
                settings.putString(SETTINGS_COLOR_HOME_BUTTONS_TAG, "1");
            } else {
                settings.putString(SETTINGS_COLOR_HOME_BUTTONS_TAG, "0");
            }
            settings.apply();
        });
        ...
        val = MainActivity.sharedPreferences.getString(SETTINGS_COLOR_HOME_BUTTONS_TAG, "");
        if (!val.isEmpty()) {
