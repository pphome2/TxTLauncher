...
import static com.wswdteam.applist.AppListApp.defaultSelectColor;
    ...
    public void favListSelect() {
        ...
        final var adapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, appList) {
            ...
            public View getView(int position, View convertView, @NonNull ViewGroup parent) {
                ...
                if (appN != null) {
                    ...
                    Drawable appI = thisApp.loadIcon(packageMan);
                    Drawable iconToDisplay = AppListActivity.getDrawable(row, appI, iconSize);
        ...
        for (String[] allAppDatum : allAppData) {
            ...
            if (selApp.contains(appName)) {
                ...
                String st = FAV_APP_NUM + " / " + selectedApp;
                tv.setText(st);
            }
        }
        ...
        appTable.setOnItemClickListener((parent, view, position, id) -> {
            ...
            TextView tv = findViewById(R.id.addFavAppInfo);
            String st1 = FAV_APP_NUM + " / " + selectedApp;
            tv.setText(st1);
